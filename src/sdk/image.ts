...
import {
  GenerateFromImageWithTextAcceptEnum,
  version1ImageGenerateFromImageWithText,
} from "../funcs/version1ImageGenerateFromImageWithText.js";
import {
  GenerateFromImageWithTextAndMaskAcceptEnum,
  version1ImageGenerateFromImageWithTextAndMask,
} from "../funcs/version1ImageGenerateFromImageWithTextAndMask.js";
import {
  GenerateFromTextAcceptEnum,
  version1ImageGenerateFromText,
} from "../funcs/version1ImageGenerateFromText.js";
...
export class Image extends ClientSDK {
   ...
   */
  async generateFromImageWithText(
    ...
    return unwrapAsync(version1ImageGenerateFromImageWithText(
      this,
      request,
      options,
    ));
   ...
   * > NOTE: Only **Version 1** engines will work with this endpoint.
   */
  async generateFromImageWithTextAndMask(
    ...
    return unwrapAsync(version1ImageGenerateFromImageWithTextAndMask(
      this,
      request,
      options,
    ));
