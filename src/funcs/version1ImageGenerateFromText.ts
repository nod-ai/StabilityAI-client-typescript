...
export enum GenerateFromTextAcceptEnum {
 ...
 */
export function version1ImageGenerateFromText(
  ...
  Result<
    operations.GenerateFromTextResponse,
    | errors.ErrorT
    | errors.ErrorT
    | APIError
    | SDKValidationError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GenerateFromTextRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/generation/{engine_id}/text-to-image")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GenerateFromTextResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
