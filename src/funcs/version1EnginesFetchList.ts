...
> {
  const parsed = safeParse(
    request,
    (value) => operations.FetchListRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.Engine$inboundSchema)),
