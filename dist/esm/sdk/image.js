...
export class Image extends ClientSDK {
    ...
    async generateFromText(request, options) {
        return unwrapAsync(version1ImageGenerateFromText(this, request, options));
    }
    /**
    ...
    async generateFromImageWithText(request, options) {
        return unwrapAsync(version1ImageGenerateFromImageWithText(this, request, options));
    }
    /**
    ...
    async generateFromImageWithTextAndMask(request, options) {
        return unwrapAsync(version1ImageGenerateFromImageWithTextAndMask(this, request, options));
    }
}
